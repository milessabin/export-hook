...
class ExportMacro[C <: XScala.Context](val c: C) {
  import c.universe._
...
object ExportMacro {
  def inst(c: XScala.Context) = new ExportMacro[c.type](c)

  def exportsImpl0[F[_], T](c: XScala.Context)(st: c.Expr[F[T]])
  ...
  def exportsImpl1[F[_[_]], T[_]](c: XScala.Context)(st: c.Expr[F[T]])
